...
void ui_homeScreen_screen_init(void)
{
    ...
    ui_pvIcon = lv_img_create(ui_homeScreen);
    ...
    ui_pvLine = lv_img_create(ui_homeScreen);
    ...
    ui_pvWatts = lv_label_create(ui_homeScreen);
    ...
    ui_pvTotal = lv_label_create(ui_homeScreen);
    ...
    ui_pvTotalUnits = lv_label_create(ui_homeScreen);
    ...
    ui_loadWatts = lv_label_create(ui_homeScreen);
    ...
    ui_battIcon = lv_img_create(ui_homeScreen);
    ...
    ui_battLine = lv_img_create(ui_homeScreen);
    ...
    ui_battSocRate = lv_label_create(ui_homeScreen);
    lv_obj_set_width(ui_battSocRate, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_battSocRate, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_battSocRate, 152);
    lv_obj_set_y(ui_battSocRate, 87);
    lv_obj_set_align(ui_battSocRate, LV_ALIGN_LEFT_MID);
    lv_label_set_text(ui_battSocRate, " - %/hr");
    lv_obj_set_style_text_color(ui_battSocRate, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_battSocRate, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui_battSocRate, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_battSocRate, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_battWatts = lv_label_create(ui_homeScreen);
    ...
    ui_battDailyCharge = lv_label_create(ui_homeScreen);
    ...
    ui_battDailyDischargeUnit = lv_label_create(ui_homeScreen);
    ...
    ui_battDailyDischarge = lv_label_create(ui_homeScreen);
    ...
    ui_battDailyChargeUnit = lv_label_create(ui_homeScreen);
    ...
    ui_battDischargeIcon = lv_img_create(ui_homeScreen);
    ...
    ui_battChargeIcon = lv_img_create(ui_homeScreen);
    ...
    ui_gridIcon = lv_img_create(ui_homeScreen);
    ...
    ui_gridLine = lv_img_create(ui_homeScreen);
    ...
    ui_gridWatts = lv_label_create(ui_homeScreen);
    ...
    ui_gridDailyExport = lv_label_create(ui_homeScreen);
    ...
    ui_gridDailyExportUnit = lv_label_create(ui_homeScreen);
    ...
    ui_gridDailyImport = lv_label_create(ui_homeScreen);
    ...
    ui_gridDailyImportUnit = lv_label_create(ui_homeScreen);
    ...
    ui_gridExportArrow = lv_img_create(ui_homeScreen);
    ...
    ui_gridImportArrow = lv_img_create(ui_homeScreen);
    ...
    ui_loadIcon = lv_img_create(ui_homeScreen);
    ...
    ui_loadLine = lv_img_create(ui_homeScreen);
    ...
    ui_loadTotal = lv_label_create(ui_homeScreen);
    ...
    ui_loadTotalUnits = lv_label_create(ui_homeScreen);
    ...
    ui_Inverter = lv_obj_create(ui_homeScreen);
    ...
    ui_syncing = lv_img_create(ui_homeScreen);
    ...
    ui_wifiHigh = lv_img_create(ui_homeScreen);
    ...
    ui_wifiMed = lv_img_create(ui_homeScreen);
    ...
    ui_wifiLow = lv_img_create(ui_homeScreen);
    ...
    ui_settingsIcon = lv_img_create(ui_homeScreen);
    ...
    ui_inverterTouch = lv_obj_create(ui_homeScreen);
    lv_obj_remove_style_all(ui_inverterTouch);
    lv_obj_set_width(ui_inverterTouch, 90);
    lv_obj_set_height(ui_inverterTouch, 82);
    lv_obj_set_align(ui_inverterTouch, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_inverterTouch, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_pvTouch = lv_obj_create(ui_homeScreen);
    lv_obj_remove_style_all(ui_pvTouch);
    lv_obj_set_width(ui_pvTouch, 186);
    lv_obj_set_height(ui_pvTouch, 121);
    lv_obj_set_x(ui_pvTouch, -135);
    lv_obj_set_y(ui_pvTouch, -93);
    lv_obj_set_align(ui_pvTouch, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_pvTouch, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_gridTouch = lv_obj_create(ui_homeScreen);
    lv_obj_remove_style_all(ui_gridTouch);
    lv_obj_set_width(ui_gridTouch, 186);
    lv_obj_set_height(ui_gridTouch, 121);
    lv_obj_set_x(ui_gridTouch, 139);
    lv_obj_set_y(ui_gridTouch, -92);
    lv_obj_set_align(ui_gridTouch, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_gridTouch, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_battTouch = lv_obj_create(ui_homeScreen);
    lv_obj_remove_style_all(ui_battTouch);
    lv_obj_set_width(ui_battTouch, 186);
    lv_obj_set_height(ui_battTouch, 121);
    lv_obj_set_x(ui_battTouch, -137);
    lv_obj_set_y(ui_battTouch, 89);
    lv_obj_set_align(ui_battTouch, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_battTouch, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_loadTouch = lv_obj_create(ui_homeScreen);
    lv_obj_remove_style_all(ui_loadTouch);
    lv_obj_set_width(ui_loadTouch, 186);
    lv_obj_set_height(ui_loadTouch, 121);
    lv_obj_set_x(ui_loadTouch, 138);
    lv_obj_set_y(ui_loadTouch, 91);
    lv_obj_set_align(ui_loadTouch, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_loadTouch, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    lv_obj_add_event_cb(ui_inverterTouch, ui_event_inverterTouch, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_pvTouch, ui_event_pvTouch, LV_EVENT_ALL, NULL);
