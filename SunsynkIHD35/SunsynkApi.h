 ...
 */
const char *SUNSYNK_LOGIN_URL = "https://pv.inteless.com/oauth/token";

/*
 * API endpoint for the Sunsynk API
 */
 ...
 */
static const char SUNSYNK_API_CERT[] = R"EOF(-----BEGIN CERTIFICATE-----
...
// certificate for https://pv.inteless.com
// DST Root CA X3, valid until Mon Sep 30 2024, size: 1923 bytes 
const char* SUNSYNK_API_CERT2 = \
"-----BEGIN CERTIFICATE-----\n" \
