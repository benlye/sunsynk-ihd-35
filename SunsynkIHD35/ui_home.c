...
void ui_home_screen_init(void)
{
    ...
    lv_label_set_text(ui_pvWatts, "1234W");
    ...
    lv_label_set_text(ui_loadWatts, "1234W");
    ...
    lv_label_set_text(ui_battSoc, "100%");
    ...
    lv_label_set_text(ui_battWatts, "1234W");
    ...
    lv_label_set_text(ui_gridWatts, "1234W");
